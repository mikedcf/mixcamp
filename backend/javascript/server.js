...
app.post('/api/v1/password/forgot', emailRateLimiter, recuperarSenha);
...
app.get(process.env.ROUTE_CAMPEONATOS_BY_SEASON_TIMES, validarApiKeyDiscord, getCampeoantosBySeasonTimes);

app.post(process.env.ROUTE_NOTIFICACOES_CRIAR_DISCORD, validarApiKeyDiscord, criarMsgNotificacaoDiscord);
